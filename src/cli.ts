...
class ProjectBuilder {
  ...
  constructor(private _watchForChanges: boolean, mode: 'parallel'|'sequential') {
  ...
  private _build(options: BuildOptions) {
    ...
    subprocess.stdout.on('data', options.onStdOut.bind(null));
    subprocess.stderr.on('data', options.onStdErr.bind(null));
